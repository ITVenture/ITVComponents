...
using AuthenticationClaimMapping = ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.Shared.Models.AuthenticationClaimMapping;
...
using ClientAppAccess = ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.Basic.Models.ClientAppAccess;
    ...
    where TImpl:SecurityContext<TImpl>
    {
        ...
        public int? CurrentTenantId
        {
            get
            {
                ...
                return currentTenantId = Tenants.FirstOrDefault(n => n.TenantNameLower == tenantProvider.PermissionPrefix.ToLower())?.TenantId;
            }
        }
