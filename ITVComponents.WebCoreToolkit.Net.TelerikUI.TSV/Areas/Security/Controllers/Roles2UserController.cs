...
namespace ITVComponents.WebCoreToolkit.Net.TelerikUi.TenantSecurityViews.Areas.Security.Controllers
{
        ...
        where TExternalOAuthServiceTenantLogin : ExternalOAuthServiceTenantLogin<TTenant, TExternalOAuthService, TExternalOAuthServiceState, TExternalOAuthServiceTenantLogin>
    {
        ...
        public Roles2UserController(TContext db, IServiceProvider services)
        {
            this.db = db;
            ...
            [FromQuery] int tenantUserId)
        {
            ...
            return Json((from p in db.SecurityRoles
                join r in db.TenantUserRoles /*.Where(n => n.TenantUserId != null && n.RoleId != null)*/
                    on new { p.RoleId, TenantUserId = tenantUserId } equals new
                        { RoleId = r.RoleId.Value, TenantUserId = r.TenantUserId.Value } into lj
        ...
        [HttpPost]
        [Authorize("HasPermission(Roles.AssignUser)")]
