...
using TenantUser = ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurityContext.Models.TenantUser;
using UserRole = ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurityContext.Models.UserRole;
