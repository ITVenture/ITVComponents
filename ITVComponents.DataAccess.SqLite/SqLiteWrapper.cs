...
using ITVComponents.DataAccess.SqLite.Resources;
...
{
    public class SqLiteWrapper:IDbWrapper
    {
        /// <summary>
        ...
        /// </summary>
        private ISqLiteDbInitializer initializer;
        ...
        /// </summary>
        /// <param name="fileName">file-path for the used sqLite connection</param>
        ...
        public SqLiteWrapper(string fileName, int commandTimeout, ISqLiteDbInitializer initializer) : this()
        {
            this.commandTimeout = commandTimeout >= 0 ? commandTimeout : int.MaxValue;
            this.fileName = initializer.GetPreciseDatabaseName(fileName);
            bool initRequired = CheckSqLiteFile();
            if (initRequired && initializer == null)
            {
            ...
            if (initRequired)
            {
                initializer.SetupDatabase(this);
            }
        }
        ...
        public SqLiteWrapper(string fileName) : this(fileName, 0, null)
        {
        }
        ...
        public IDbDataParameter GetParameter(string name, object value, string typeName = null)
        {
            ...
            {
                throw new ArgumentException("Structured Types are not supported by SqLite! #hetmiagschisse");
            }
        }
        ...
        private bool EnsureConnected()
        {
            ...
            if (connection.State == ConnectionState.Closed || connection.State == ConnectionState.Broken)
            {
                ...
                {
                    LogEnvironment.LogEvent(ex.ToString(), LogSeverity.Error, "SqLite");
                }
