...
namespace ITVComponents.ParallelProcessing
{
    ...
    public abstract class ParallelTaskProcessor: IStatusSerializable, IStoppable
    {
        ...
        protected ParallelTaskProcessor(string identifier, Func<ITaskWorker> worker, int highestPriority, int lowestPriority, int workerCount, int workerPollTime, int lowTaskThreshold, int highTaskThreshold, bool useAffineThreads, bool useTasks, bool runWithoutSchedulers, WatchDog watchDog) :
            this(identifier, worker, highestPriority, lowestPriority, workerCount, workerPollTime, lowTaskThreshold, highTaskThreshold, useAffineThreads, useTasks, runWithoutSchedulers)
        {
        ...
        /// <param name="highTaskThreshold">the maximum number of Items that should be queued in a workerQueue</param>
        /// <param name="useAffineThreads">indicates whether to use ThreadAffinity in the workers</param>
        protected ParallelTaskProcessor(string identifier, Func<ITaskWorker> worker, int highestPriority, int lowestPriority, int workerCount, int workerPollTime, int lowTaskThreshold, int highTaskThreshold, bool useAffineThreads, bool useTasks, bool runWithoutSchedulers)
            : this()
        {
