...
using ITVComponents.WebCoreToolkit.EntityFramework.AspNetCoreTreeTenants.Extensions;
...
using ITVComponents.WebCoreToolkit.EntityFramework.TenantTreeShared.Interceptors;
...
using HealthCheckExtensions = ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurityShared.Extensions.HealthCheckExtensions;
...
namespace ITVComponents.WebCoreToolkit.EntityFramework.AspNetCoreTreeTenants
{
    ...
    public static class WebPartInit
    {
        ...
        public static void SetContextType(Type contextType)
        {
            ...
            var t = contextType ?? typeof(AspNetTreeSecurityContext);
            ...
            init.ExtendWithStatic(typeof(EntityFramework.TenantTreeShared.Extensions.DependencyExtensions), t,
            ...
            [SharedObjectHeap]ISharedObjHeap sharedObjects)
        {
            ...
            {
                TenantTreeShared.Extensions.DependencyExtensions.UseDbGlobalSettings(services);
            }
            ...
            {
                TenantTreeShared.Extensions.DependencyExtensions.UseDbLogAdapter(services);
            }
                ...
                foreach (var item in partActivation.HealthChecks)
                {
                    ...
                    if (apply)
                    {
                        HealthCheckExtensions
                            .AddScriptedCheck<ScriptedHealthCheck<HierarchyTenantContextSecurityTrustConfig>,
                                HierarchyTenantContextSecurityTrustConfig>(builder, item.Label);
                    }
                }
            }
        }
            ...
            [WebPartConfig("ActivationSettings")] ActivationOptions partOptions)
        {
            ...
            if (partOptions.UseDefaultInterceptors)
            {
                optionsBuilder.AddInterceptors(
                    new SecurityModificationInterceptor<HierarchyTenant, string, User, Role, Permission, UserRole, RolePermission,
                        HierarchyTenantUser, RoleRole, GlobalRole, GlobalRolePermission, GRoleLRole>(services));
            }
        }
    }
}
