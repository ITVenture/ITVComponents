...
using ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Helpers;
using ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Navigation;
using ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Security;
using ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Security.ApplicationToken;
using ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Security.SharedAssets;
    ...
    public static class DependencyExtensions
    {
        ...
        public static IServiceCollection UseDbIdentities(this IServiceCollection services, Action<IServiceProvider, DbContextOptionsBuilder> options)
        {
            ...
            return services.AddDbContext<AspNetSecurityContext>(options)
                .AddScoped<IDbContextFactory<AspNetSecurityContext>, ToolkitDbContextFactory<AspNetSecurityContext>>()
                .AddScoped<ICoreSystemContextFactory, CoreSystemContextFactory<AspNetSecurityContext>>()
                .AddScoped<IToolkitContextFactory, ToolkitContextFactory<AspNetSecurityContext>>()
