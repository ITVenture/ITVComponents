        ...
        where TExternalOAuthServiceTenantLogin : ExternalOAuthServiceTenantLogin<TTenant, TExternalOAuthService, TExternalOAuthServiceState, TExternalOAuthServiceTenantLogin>
    {
        ...
        public IActionResult Read([DataSourceRequest] DataSourceRequest request, int tenantId, [FromQuery] int roleId)
        {
            ...
            return Json((from p in db.SecurityRoles
                             join r in db.RoleRoles/*.Where(n => n.PermissiveRoleId != null && n.PermittedRoleId != null)*/ on new { p.RoleId, PermissiveRoleId = roleId } equals new { RoleId = r.PermittedRoleId.Value, PermissiveRoleId = r.PermissiveRoleId.Value } into lj
                             ...
                             }).ToArray().Where(n => !db.IsCyclicRoleInheritance(roleId, n.RoleId)).ToDataSourceResult(request, ModelState));
        }
