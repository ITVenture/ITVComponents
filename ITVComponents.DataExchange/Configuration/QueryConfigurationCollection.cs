...
{
    [Serializable]
    public class QueryConfigurationCollection : List<QueryConfiguration>
    {
        /// <summary>
        ...
        public QueryConfiguration this[string name] => this.FirstOrDefault(n => name.Equals(n.Name, StringComparison.OrdinalIgnoreCase));
    }
}
