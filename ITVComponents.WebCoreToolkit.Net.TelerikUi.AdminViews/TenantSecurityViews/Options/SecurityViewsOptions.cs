...
namespace ITVComponents.WebCoreToolkit.Net.TelerikUi.AdminViews.TenantSecurityViews.Options
{
    public class SecurityViewsOptions
    {
        ...
        public Dictionary<string, string> CustomViewGenericArgs { get; set; } = new Dictionary<string, string>();
    }
