...
namespace ITVComponents.WebCoreToolkit.Blazor.MudBlazor.WorkflowViews.Tasks.Handlers
{
    ...
    public interface IWorkflowTaskHandler
    {
        ...
        /// <c>RequiredPermission</c> der Benutzer hat (oder die keine verlangen).
        /// </summary>
        ...
        /// </summary>
        Task<IReadOnlyList<string>> ListTaskKeysAsync(ClaimsPrincipal user);
        ...
        Task ReleaseClaimAsync(ClaimsPrincipal user, string instanceId, string tokenId);
