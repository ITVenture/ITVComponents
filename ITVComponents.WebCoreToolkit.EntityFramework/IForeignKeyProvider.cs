...
namespace ITVComponents.WebCoreToolkit.EntityFramework
{
    public interface IForeignKeyProvider
    {
        ...
        IEnumerable GetForeignKeyFilterQuery(string tableName, out Type keyType);
        ...
        /// <returns>the query that will be executed go get the foreignkey-data</returns>
        IEnumerable GetForeignKeyFilterQuery(string tableName, Dictionary<string, object> postedFilter, out Type keyType);
        ...
        /// <returns>the query that will be executed go get the foreignkey-data</returns>
        IEnumerable GetForeignKeyResolveQuery(string tableName, object id, out Type keyType);
    }
}
