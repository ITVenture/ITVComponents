...
public class FeatureActivationAdminHandler<TContext, TTenant, TUserId, TUser, TRole, TPermission, TUserRole, TRolePermission,
    ...
    TExternalOAuthServiceState, TExternalOAuthServiceTenantLogin, TTrustConfig> : IFeatureActivationAdminHandler
    ...
    where TExternalOAuthServiceTenantLogin : ExternalOAuthServiceTenantLogin<TTenant, TExternalOAuthService, TExternalOAuthServiceState, TExternalOAuthServiceTenantLogin>
{
    ...
    public async Task<PagedResult<FeatureActivationViewModel>> ListActivationsAsync(ClaimsPrincipal user, int featureId, ListQuery query)
    {
        ...
        var q = from a in db.TenantFeatureActivations.AsNoTracking()
                ...
                select new FeatureActivationViewModel
                {
                    TenantFeatureActivationId = a.TenantFeatureActivationId,
                    FeatureId = a.FeatureId,
                    TenantId = a.TenantId,
                    TenantDisplayName = tn != null ? (tn.DisplayName ?? tn.TenantName) : null,
                    ActivationStart = a.ActivationStart,
                    ActivationEnd = a.ActivationEnd
                };
    ...
    public async Task<FeatureActivationViewModel?> CreateActivationAsync(ClaimsPrincipal user, FeatureActivationViewModel input)
    {
        ...
        db.TenantFeatureActivations.Add(entity);
        await db.SaveChangesAsync();
        input.TenantFeatureActivationId = entity.TenantFeatureActivationId;
        return input;
    }
    ...
    public async Task<FeatureActivationViewModel?> UpdateActivationAsync(ClaimsPrincipal user, FeatureActivationViewModel input)
    {
        ...
        entity.ActivationEnd = input.ActivationEnd;
        await db.SaveChangesAsync();
        return input;
    }
