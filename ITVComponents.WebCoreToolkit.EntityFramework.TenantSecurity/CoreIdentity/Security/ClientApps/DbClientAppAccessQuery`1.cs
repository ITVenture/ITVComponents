...
namespace ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.Security.ClientApps
{
    ...
    /// der Basisklasse.
    /// </summary>
    internal class AspNetClientAppAccessQuery<TImpl> : DbClientAppAccessQuery<TImpl, Tenant, string, User, Role, Permission, UserRole, RolePermission, TenantUser, RoleRole, GlobalRole, GlobalRolePermission, GRoleLRole, AppPermission, AppPermissionSet, ClientAppPermission, ClientApp, ClientAppAccess>
