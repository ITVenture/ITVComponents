...
public class TscUserAdminHandler<TContext, TTenant, TRole, TPermission, TUserRole, TRolePermission,
    ...
    where TAppPermission : AppPermission<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppTemplate>
    where TAppPermissionSet : AppPermissionSet<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppTemplate>
    where TClientAppTemplate : ClientAppTemplate<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppTemplate>
    where TClientAppPermission : ClientAppPermission<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppPermission, TClientApp, TClientAppAccess, TClientAppTemplate>
    where TClientApp : ClientApp<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppPermission, TClientApp, TClientAppAccess, TClientAppTemplate>
    where TClientAppAccess : ClientAppAccess<TTenant, int, TscModels.User, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TAppPermission, TAppPermissionSet, TClientAppPermission, TClientApp, TClientAppAccess, TClientAppTemplate>
    ...
    //where TUser: class
{
    ...
    // Basic (TenantSecurityContext) users are not ASP.NET-Core-Identity users: no email/logins/tokens/claims,
    // but they carry an authentication-type id. Drives the unified Users view/grid (see IUserAdminHandler).
    public bool SupportsEmail => false;
    public bool SupportsLogins => false;
    public bool SupportsTokens => false;
    public bool SupportsClaims => false;
    public bool ShowAuthenticationType => true;

    public TscUserAdminHandler(IDbContextFactory<TContext> dbFactory, IServiceProvider services)
    {
    ...
    public Task<PagedResult<UserLoginViewModel>> ListLoginsAsync(ClaimsPrincipal user, string userId, ListQuery query)
    ...
    public Task<PagedResult<UserTokenViewModel>> ListTokensAsync(ClaimsPrincipal user, string userId, ListQuery query)
    ...
    public Task<PagedResult<UserClaimViewModel>> ListClaimsAsync(ClaimsPrincipal user, string userId, ListQuery query)
