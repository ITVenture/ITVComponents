...
namespace ITVComponents.WebCoreToolkit.Net.TelerikUi.COB.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private readonly IOptions<OnboardingOptions> onboardingOptions;
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(User user)
        {
            ...
            AuthenticatorUri = GenerateQrCodeUri(email, onboardingOptions.Value.ProductTag, unformattedKey);
        }
        ...
        private string GenerateQrCodeUri(string email, string productTag, string unformattedKey)
        {
            return string.Format(
                AuthenticatorUriFormat,
                _urlEncoder.Encode(productTag),
