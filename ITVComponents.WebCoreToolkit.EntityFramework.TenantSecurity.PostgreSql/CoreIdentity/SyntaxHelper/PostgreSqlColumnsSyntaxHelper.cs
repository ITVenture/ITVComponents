...
namespace ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.CoreIdentity.PostgreSql.SyntaxHelper
{
    public static class PostgreSqlColumnsSyntaxHelper
    {
        public static void ConfigureComputedColumns<TContext>(DbContextModelBuilderOptions<TContext> builderOptions)
        {
            ...
            builderOptions.ConfigureComputedColumn<Tenant, string>(t => t.TenantNameLower,
                "lower(\"TenantName\")", stored: true);
