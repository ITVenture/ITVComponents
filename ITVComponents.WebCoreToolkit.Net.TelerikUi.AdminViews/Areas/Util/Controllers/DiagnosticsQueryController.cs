...
using ITVComponents.WebCoreToolkit.Net.TelerikUi.AdminViews.ViewModel;
        ...
        where TExternalOAuthServiceTenantLogin : ExternalOAuthServiceTenantLogin<TTenant, TExternalOAuthService, TExternalOAuthServiceState, TExternalOAuthServiceTenantLogin>
    {
        ...
        public async Task<IActionResult> Create([DataSourceRequest] DataSourceRequest request, DiagnosticsQueryViewModel viewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                /* Nicht gemergte Änderung aus Projekt "ITVComponents.WebCoreToolkit.Net.TelerikUi.AdminViews (netcoreapp3.1)"
                Vor:
