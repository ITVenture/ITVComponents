...
{
    public interface IDownloadPersonalDataHandler:IPageHandlerInstance<DownloadPersonalDataModel>
    {
        Task<UserQueryTicket> FetchUser(ClaimsPrincipal user);
        string GetUserId(ClaimsPrincipal user);
        Task<IDictionary<string,string>> FetchPersonalData(UserQueryTicket user);
