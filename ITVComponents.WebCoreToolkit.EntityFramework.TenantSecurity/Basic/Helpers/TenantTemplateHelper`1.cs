...
namespace ITVComponents.WebCoreToolkit.EntityFramework.TenantSecurity.Basic.Helpers
{
    ...
    {
        public TenantTemplateHelper(TContext db, ILogger<TenantTemplateHelper<TContext>> logger, IEnumerable<ITenantTemplatePartHandler> partHandlers = null) : base(db, logger, partHandlers)
        {
        }
    }
}
