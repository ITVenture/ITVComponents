...
{
    [Index(nameof(DashboardWidgetId), nameof(LocaleName), IsUnique = true, Name = "IX_UniqueDashboardLocaleDef")]
    public abstract class DashboardWidgetLocalization<TTenant, TUserId, TUser, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole, TQuery, TQueryParameter, TTenantQuery, TWidget, TWidgetParam, TWidgetLocalization>:IDashboardRawDefinition
