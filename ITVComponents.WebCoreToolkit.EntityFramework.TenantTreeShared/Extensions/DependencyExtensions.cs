...
namespace ITVComponents.WebCoreToolkit.EntityFramework.TenantTreeShared.Extensions
{
    public static class DependencyExtensions
    {
        ...
        {
            return TenantSecurityShared.Extensions.DependencyExtensions.UseDbLogAdapter(services);
        }
        ...
        {
            return TenantSecurityShared.Extensions.DependencyExtensions.UseDbGlobalSettings(services);
        }
