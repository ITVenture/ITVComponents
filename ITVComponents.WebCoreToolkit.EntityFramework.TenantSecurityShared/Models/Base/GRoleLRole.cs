...
{
    public class GRoleLRole<TTenant, TUserId, TUser, TRole, TPermission, TUserRole, TRolePermission, TTenantUser, TRoleRole, TGlobalRole, TGlobalRolePermission, TGRoleLRole>
    ...
    {
        [Key]
        public int GRoleLRoleId { get; set; }
        public int GlobalRoleId { get; set; }
        public int LocalRoleId { get; set; }
        public int? OriginId { get; set; }
        public int? RoleRoleId { get; set; }

        [ForeignKey(nameof(GlobalRoleId))]
        public virtual TGlobalRole GlobalRole { get; set; }
        
        [ForeignKey(nameof(LocalRoleId))]
        public virtual TRole LocalRole { get; set; }

        [ForeignKey(nameof(OriginId))]
        public virtual TGRoleLRole Origin { get; set; }

        [ForeignKey(nameof(RoleRoleId))]
        public virtual TRoleRole LinkedBy { get; set; }

        public virtual ICollection<TGRoleLRole> RoleInheritanceChildren { get; set; } = new List<TGRoleLRole>();
    }
}
