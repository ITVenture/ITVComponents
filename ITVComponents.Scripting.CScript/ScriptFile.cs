...
namespace ITVComponents.Scripting.CScript
{
    ...
    /// <remarks>
    /// Fuehrt ueber den Interpreter aus. Ging aus dem waehrend der Umstellung parallel
    /// gefuehrten InterpretedScriptFile hervor und hat den ScriptVisitor-basierten Vorgaenger
    /// abgeloest - daher wieder der schlichte Name ScriptFile im Namensraum
    /// ITVComponents.Scripting.CScript.
    ///
    /// Der abgeloeste Vorgaenger musste ein Neuladen anhalten, bis keine Ausfuehrung mehr lief:
    /// er tauschte den ANTLR-Baum aus, den laufende Ausfuehrungen gerade begingen. Hier ist das
    /// uebersetzte Script unveraenderlich, ein Neuladen also ein blosser Referenzwechsel.
    /// Laufende Ausfuehrungen behalten ihren Stand, neue nehmen den neuen - Laufzaehler und
    /// Wartesperre entfallen ersatzlos.
    /// </remarks>
    public class ScriptFile<TOutput>
    {
        ...
        /// <summary>
        /// Fuehrt das Script in einer bestehenden Repl-Sitzung aus.
        /// </summary>
        /// <param name="session">die laufende Sitzung, aus der der Scope stammt</param>
        /// <returns>das Ergebnis des Scripts</returns>
        /// <remarks>
        /// Diesen Weg nehmen verschachtelte Aufrufe ueber DefaultCallbacks (Run/RunStream) und
        /// Aufrufer wie ScriptedConstraint oder ScriptedHealthCheck, die dem Script eine bereits
        /// vorbereitete Sitzung mitgeben. Der Scope steckt in der Sitzung; das Script laeuft in
        /// genau diesem Scope und teilt sich dessen Variablen mit dem Aufrufer - wie zuvor beim
        /// ScriptVisitor, nur dass jetzt der Interpreter gegen den Scope ausfuehrt.
        /// </remarks>
